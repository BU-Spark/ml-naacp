...
class NeuralNetwork(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim):
        ...
        self.conv_0 = nn.Conv1d(input_dim, 500, 35, stride=5)
        self.linear_0 = nn.Linear(500, 500)
       # self.conv_1 = nn.Conv1d(500, 500, 35, stride=5)
        #self.conv_2 = nn.Conv1d(500, 500, 35, stride=5)
        self.conv_1 = nn.Conv1d(500, 500, 35, stride=5)

        self.linear_1 = nn.Linear(500, 150)

        self.conv_2 = nn.Conv1d(150, 150, 35, stride=5)

        self.linear_2 = nn.Linear(150, 150)
        self.relu = nn.ReLU()

        #self.normal = torch.nn.BatchNorm1d(hidden_dim)
        self.linear_final = nn.Linear(150, output_dim)
...
def train_network(X_train, y_train, X_test, y_test):
    ...
    print("> topicModel: topicNetwork: saving train and test dataloaders")
