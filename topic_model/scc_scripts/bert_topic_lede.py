...
embeddings_lede = sentence_model.encode(lede)
...
topic_lede, prob_lede = bglobe_topicmodel.fit_transform(lede, embeddings_lede)

print("save topic model...")
bglobe_topicmodel.save("bglobe_519_lede")